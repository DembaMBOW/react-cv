export const portfolioData = [
  {
    ...
    languages: ['tout','html','css', 'php'],
    languagesIcons: ['fab fa-html','fab fa-php','fab fa-css3-alt'],
    source: 'https://github.com/needforschool/nfactory-bookination',
    info: "Bookination est un projet dans le cadre d'une formation NFactory School qui consiste à développer une solution web qui permet aux patients de renseigner leur carnet de vaccinations.",
    picture: './media/project-bookination1.jpg'
  },
  {
    id: 2,
    name: 'Project Ubersitter',
    languages: ['tout','typescript','javascript','react', 'SASS'],
  ...
  },
  {
    ...
    languages: ['tout','WordPress','php','css'],
